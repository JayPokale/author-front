  ...
  return (
    <>
      ...
      <div class="max-w-2xl mx-auto text-justify py-4">
        <h1>
          <strong>Disclaimer for AuthorsLog</strong>
        </h1>

        <p>
          If you require any more information or have any questions about our
          site's disclaimer, please feel free to contact us by email at
          jay.pokale.35@gmail.com. Our Disclaimer was generated with the help of
          the Free Disclaimer Generator.
        </p>

        <h2>
          <strong>Disclaimers for AuthorsLog</strong>
        </h2>

        <p>
          All the information on this website -
          https://solid-full-stack.vercel.app/ - is published in good faith and
          for general information purpose only. AuthorsLog does not make any
          ...
          website (AuthorsLog), is strictly at your own risk. AuthorsLog will
